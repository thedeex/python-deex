...
from deex.blockchainobject import BlockchainObject, ObjectCache
from deex.asset import Asset
from deex.account import Account
from deex.proposal import Proposals, Proposal

from deexbase.operationids import operations
...
# deex instance
deex = DeEx(
    "wss://node.deex.eu", keys=wifs, nobroadcast=True, num_retries=1
)
config = deex.config
