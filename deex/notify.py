...
from deexapi.websocket import DeExWebsocket
...
class Notify(Events, BlockchainInstance):
    ...
    :param list markets: Instances of :class:`deex.market.Market` that identify markets to be monitored
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from deex.notify import Notify
        from deex.market import Market
    ...
    def process_market(self, data):
        ...
        * :class:`deex.price.Order` or
        * :class:`deex.price.FilledOrder` or
        * :class:`deex.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        ...
        :class:deex.account.AccountUpdate`
        """
