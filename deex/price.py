...
class Price(GraphenePrice):
    ...
    with the tuple::
        ...
        each being an instance of :class:`deex.amount.Amount`. The
        ...
        :param deex.asset.Asset base: Base asset
        :param deex.asset.Asset quote: Quote asset
        :param deex.deex.DeEx blockchain_instance: DeEx instance
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a floating number and ``base`` and ``quote`` being instances of :class:`deex.asset.Asset`
            ...
            * ``args`` being a list of ``[quote, base]`` both being instances of :class:`deex.amount.Amount`
            * ``args`` being a list of ``[quote, base]`` both being instances of ``str`` (``amount symbol``)
            * ``base`` and ``quote`` being instances of :class:`deex.asset.Amount`
        ...
        * ``Price(1.0, "USD/GOLD")``
        ...
        .. code-block:: python
            ...
            >>> from deex.price import Price
            >>> Price("0.3314 USD/DEEX") * 2
            0.662600000 USD/DEEX
    """
    ...
    def market(self):
        ...
        :returns: Instance of :class:`deex.market.Market` for the
...
class Order(Price):
    """
    This class inherits :class:`deex.price.Price` but has the ``base`` and
    ...
    def __init__(self, *args, **kwargs):
        ...
        # https://github.com/deex/python-deex/issues/234
...
class UpdateCallOrder(Price):
    """ This class inherits :class:`deex.price.Price` but has the ``base``
