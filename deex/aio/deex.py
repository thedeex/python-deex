...
from deexapi.aio.deexnoderpc import DeExNodeRPC
...
from ..deex import DeEx as SyncDeEx


log = logging.getLogger(__name__)


class DeEx(AbstractGrapheneChain, SyncDeEx):
    """
    DeEx async client.

    This is an asyncio version of :class:`deex.DeEx`
    ...
    async def subscribe_to_market(self, market, event_id=4):
        ...
        :param str,deex.aio.Market market: market to set subscription
            on
        """
