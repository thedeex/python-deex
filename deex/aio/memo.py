...
class Memo(GrapheneMemo):
    ...
    :param deex.aio.account.Account from_account: Account that has sent
        the memo
    :param deex.aio.account.Account to_account: Account that has received
        the memo
    ...
    .. code-block:: python
        ...
        from deex.aio.memo import Memo
        m = await Memo("deexeu", "wallet.xeroc")
